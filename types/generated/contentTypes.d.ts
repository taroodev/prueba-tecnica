...
export interface ApiDailyMenuDailyMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dessert_dish: Schema.Attribute.Relation<'oneToOne', 'api::dishe.dishe'>;
    first_dish: Schema.Attribute.Relation<'oneToOne', 'api::dishe.dishe'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDisheDishe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    allergens: Schema.Attribute.Component<'allergenes.allergen', true> &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::dishe.dishe'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
